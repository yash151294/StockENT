...
const MessagesPage: React.FC = () => {
  ...
  }, [socket, isConnected, selectedConversation, queryClient, state.user?.id, showSuccess, showWarning, router, markConversationAsReadMutation, clearMessageNotificationsForConversation]);
                      ...
                      {currentConversation && (
                        <>
                          ...
                          <Button
                            variant="outlined"
                            size="small"
                            onClick={() => router.push(`/products/${currentConversation.product?.id}`)}
